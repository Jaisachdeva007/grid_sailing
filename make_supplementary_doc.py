...
def draw_grid_img(start, goal, trail=None, cell=52, gap=5, n=10, pad=9):
...
add_para(
    ...
    "on a 10×10 grid using a three-button numeric keypad. Each keypress moves the cursor in a "
...
add_para(
    ...
    "possible start cell on the 10×10 grid. Because BFS explores cells in order of increasing "
